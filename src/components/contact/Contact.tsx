      ...
      <div className="sheet-container">
        ...
        <div className="contact-body">
          ...
          >
            ...
            <div className="form-group">
              <label htmlFor="email" className="custom-tag">
                Email
              </label>
              <input
                type="email"
            ...
            <div className="form-group">
              <label htmlFor="message" className="custom-tag">
                Message
              </label>
              <textarea
                name="message"
          ...
          <div className="left-body">
            ...
            <div className="main">
              ...
              <div className="down">
                ...
                <a
                  href="https://discordapp.com/users/1019565322681974806"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn card4 m-0"
                >
                  <svg
                    height="30px"
                    width="30px"
